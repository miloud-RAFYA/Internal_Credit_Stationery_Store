...
<div class="py-6">
    <div class="flex items-center justify-between mb-6">
        ...
        <a href="{{ route('admin.utilisateurs.create') }}" class="px-4 py-2 bg-indigo-600 text-white rounded-lg">+ Ajouter</a>
        @endcan
    </div>
            ...
            <tbody class="divide-y divide-slate-100">
                ...
                <tr class="hover:bg-slate-50 transition">
                    ...
                    <td class="px-6 py-4 text-center flex justify-center gap-2">
                        <a href="{{ route('admin.utilisateurs.show', $user->id) }}" class="px-3 py-1 bg-slate-100 text-slate-700 rounded hover:bg-slate-200">Voir</a>
                        @can('update', $user)
                        <a href="{{ route('admin.utilisateurs.edit', $user->id) }}" class="px-3 py-1 bg-blue-100 text-blue-700 rounded hover:bg-blue-200">Modifier</a>
                        @endcan
